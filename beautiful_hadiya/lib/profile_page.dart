        ...
        child: Column(
          children: [
            ...
            CrouselSliderAnimation(
                ans1: ans0, images: imgList0, ans2: const [], ans3: []),
            const SizedBox(
              height: 20,
            ),
            const Text(
            ...
            Column(
              children: [
                CrouselSliderAnimation(
                    ans1: ans1, images: imgList1, ans2: const [], ans3: []),
                const SizedBox(
                  height: 20,
                ),
                const Text(
                ...
                Column(
                  children: [
                    CrouselSliderAnimation(
                        ans1: ans3, images: imgList3, ans2: const [], ans3: []),
                  ],
                ),
                const SizedBox(
                  height: 20,
                ...
                Column(
                  children: [
                    CrouselSliderAnimation(
                        ans1: ans4, images: imgList4, ans2: const [], ans3: []),
                  ],
                ),
              ],
            ),
